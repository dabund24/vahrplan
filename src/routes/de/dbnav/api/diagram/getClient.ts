...
export class GetDiagramApiClient extends NonApiUsable<ReqType, DiagramData>()(
	QueryParamSettable<ReqType, DiagramData>()(ApiClient<ReqType, DiagramData, "GET", RequestEvent>)
) {
	protected override readonly methodType = "GET";
	protected override readonly route = "/de/dbnav/api/diagram";
