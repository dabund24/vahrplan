...
<div class="content-wrapper">
	...
	<p
		...
		Text aufgef&uuml;hrten Datenschutzerkl&auml;rung.</p
	>
	...
	<p
		>Details entnehmen Sie der Datenschutzerkl&auml;rung von Hetzner: <a
			...
			>https://www
			.hetzner.com/de/legal/privacy-policy/https://www.hetzner.com/de/legal/privacy-policy/</a
		>.</p
	>
	<p
		>Die Verwendung von Hetzner erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben
	...
	>
	<h2 id="web-storage">4. Datenerfassung auf dieser Website</h2>
	<h3>Web Storage (Session Storage und Local Storage)</h3>
	<p
		>Unsere Internetseiten verwendet die Browser-Technologie &bdquo;Web-Storage&ldquo;.
		Web-Storage enthält kleine Datenpakete und richtet auf Ihrem Endger&auml;t keinen Schaden
		an. Die Daten werden entweder vor&uuml;bergehend f&uuml;r die Dauer einer Sitzung (Session
		Storage) oder dauerhaft (Local Storage) auf Ihrem Endger&auml;t gespeichert. Das Session
		Storage wird nach Ende Ihres Besuchs automatisch gel&ouml;scht. Daten im Local Storage
	...
	>
	<p
		>Daten des Web-Storage können verschiedene Funktionen haben. Zahlreiche Daten sind technisch
		notwendig, da bestimmte Webseitenfunktionen ohne diese nicht funktionieren w&uuml;rden
		(z.&nbsp;B. die Lesezeichenfunktion). Andere Daten speichert diese Website nicht.</p
	>
	<p
		>Daten des Web-Storage, die zur Durchf&uuml;hrung des elektronischen Kommunikationsvorgangs,
		zur Bereitstellung bestimmter, von Ihnen erw&uuml;nschter Funktionen (z.&nbsp;B. f&uuml;r
		die Lesezeichen-Funktion) erforderlich sind (notwendige Daten), werden auf Grundlage von
		Art. 6 Abs. 1 lit. f DSGVO gespeichert, sofern keine andere Rechtsgrundlage angegeben wird.
		Der Websitebetreiber hat ein berechtigtes Interesse an der Speicherung von notwendigen Daten
		im Web-Storage zur technisch fehlerfreien und optimierten Bereitstellung seiner Dienste.
		Sofern eine Einwilligung zur Speicherung von Daten im Web-Storage und vergleichbaren
		Wiedererkennungstechnologien abgefragt wurde, erfolgt die Verarbeitung ausschlie&szlig;lich
		auf Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG);
		die Einwilligung ist jederzeit widerrufbar.</p
	>
	<p
		>Sie k&ouml;nnen Ihren Browser so einstellen, dass Sie &uuml;ber die Nutzung von Web-Storage
		informiert werden und Daten im Web-Storage nur im Einzelfall erlauben, die Nutzung des
		Web-Storage f&uuml;r bestimmte F&auml;lle oder generell ausschlie&szlig;en sowie das
		automatische L&ouml;schen der Daten beim Schlie&szlig;en des Browsers aktivieren. Bei der
		Deaktivierung des Web-Storage kann die Funktionalit&auml;t dieser Website eingeschr&auml;nkt
		sein.</p
	>
	<h3>Cookies</h3>
	...
	<p
		...
		Websitebetreiber hat ein berechtigtes Interesse an der Analyse des Nutzerverhaltens, um sein
